...
export class Ember extends Entity {
    ...
    draw(spriteManager, ctx) {
        ...
        spriteManager.drawSprite(ctx, "e_" + this.curr_sprite, 0, 0);
        ctx.restore();
    }
    ...
    attack() {
        ...
        switch (s.move_x + 2 * s.move_y) {
            case -1: // выстрел влево
                s.pos_x = this.pos_x - s.size_x - Math.floor(this.size_x / 2);
                s.pos_y = this.pos_y;
                break;
            ...
            case -2: // выстрел вверх
                s.pos_x = this.pos_x;
                s.pos_y = this.pos_y - Math.floor((s.size_y + this.size_y) / 2);
                break;
            case 2: // выстрел вниз
                s.pos_x = this.pos_x;
    ...
    kill() {
        ...
        this.physicManager.gameManager.score += 150;
